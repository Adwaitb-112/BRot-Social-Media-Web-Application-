...
function Nav() {
    ...
    return (
        <div className='w-[90%] lg:w-[40%] h-[80px] bg-black flex justify-around items-center fixed bottom-[20px] rounded-full
shadow-2xl shadow-[#000000] z-[100]'>
            ...
            <div onClick={() => navigate("/upload")}><FaPlus className='text-white w-[25px] h-[25px] cursor-pointer' /></div>
            <div onClick={() => navigate("/loops")}><GoVideo className='text-white w-[25px] h-[25px] cursor-pointer' /></div>
