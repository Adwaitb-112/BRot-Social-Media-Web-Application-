    ...
    return (
        <div className='relative bg-black w-full h-[100vh]'>
            <div className='flex items-center gap-[15px] px-[20px] py-[10px] fixed top-0 z-[100] bg-black w-full'>
                <div className='h-[80px] flex items-center gap-[20px] px-[20px]'><IoMdArrowRoundBack className='text-white cursor-pointer w-[25px] h-[25px]' onClick={() => navigate(`/`)} />
                </div>
                ...
                <div>
                    <div className='text-[18px] text-white font-semibold'>{selectedUser?.userName}</div>
                    <div className='text-[16px] text-gray-400 font-semibold'>{selectedUser?.name}</div>
                </div>
            </div>
            ...
            <div className='w-full h-[80px] fixed bottom-0 flex justify-center items-center bg-black z-[100]'>
                <form className='w-[90%] max-w-[800px] h-[80%] rounded-full bg-[#131616] flex items-center gap-[10px] px-[20px] relative' onSubmit={handleSendMessage}>
                    ...
                    <div onClick={() => imageInput.current.click()}><BiImageAdd className='w-[28px] h-[28px] text-white' /></div>
                    {(input || frontendImage) && <button className='cursor-pointer w-[60px] h-[40px] rounded-full bg-gradient-to-br from-[#9500ff] to-[#ff0095] flex items-center justify-center' ><BsFillSendFill className='w-[28px] h-[28px] text-white' /></button>}
                </form>
            </div>
