...
export const like = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: `likePosts error ${error}` })
    }
}
...
export const comment = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: `commentPosts error ${error}` })
    }
}
...
export const saved = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: `savePosts error ${error}` })
    }
}